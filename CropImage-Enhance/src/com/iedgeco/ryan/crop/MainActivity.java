...
public class MainActivity extends Activity {
	...
	private static final String IMAGE_FILE_LOCATION = Environment.getExternalStorageDirectory()+"/qqnew.jpg";
	...
	public void onClick(View v){
		...
		case R.id.buttonChooseBigPicture:
			...
			//1:1就变成了圆形裁剪,和手机有关系,不知道情况，改成1.001,框的大小变成自由拖动了
			intent.putExtra("aspectX", 1.001);
			intent.putExtra("aspectY", 1);
